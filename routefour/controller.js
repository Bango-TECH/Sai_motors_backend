...
const fouruploadImage = async (req, res) => {
...
const fourgetImage = async (req, res) => {
  try {
    const data = await fourmodal.find({});
...
const fourdeletrow = async (req, res) => {
  try {
    const { UniqueID } = req.params;
    const data = await fourmodal.findOneAndDelete({ UniqueID });
    if (data) {
