...
const pickupmodal = require("./model");
...
const pickupuploadImage = async (req, res) => {
...
const pickupgetImage = async (req, res) => {
  try {
    const data = await pickupmodal.find({});
...
const pickupdeletrow = async (req, res) => {
  try {
    const { UniqueID } = req.params;
    const data = await pickupmodal.findOneAndDelete({ UniqueID });
    if (data) {
